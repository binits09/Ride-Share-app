    ...
    >
      ...
      <div className="p-4 border-b bg-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-gray-900 leading-5">{user?.name || "User"}</p>
            {user?.email && (
      ...
      {/* Menu Items */}
      <div className="p-2 space-y-1" role="menu" aria-label="Account menu">
        <button
          type="button"
          onClick={() => {
